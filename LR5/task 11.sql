/* Составьте список общего количества часов,
забронированных на один объект, помня, что интервал длится полчаса. 
...
SELECT b.facid, f.facility, ROUND(SUM(b.slots) / 2, 2) AS 'Забронированные часы'
  FROM bookings b
